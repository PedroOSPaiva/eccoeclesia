...
final class PasswordChangeHandler implements HttpHandler {

    private final AuthTokenService authTokenService;
    private final FinanceHttpResponseWriter responseWriter;
    private final FinanceHttpJson json;

    PasswordChangeHandler(AuthTokenService authTokenService, FinanceHttpResponseWriter responseWriter, FinanceHttpJson json) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            authTokenService.changePassword(authorization, values.get("password"));
