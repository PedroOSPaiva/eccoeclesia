...
@Configuration
@EnableConfigurationProperties({JwtProperties.class, AdminProvisioningProperties.class})
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/inventory/**").hasAuthority(UserHttpAuthorities.MANAGE_INVENTORY)
                        .requestMatchers(HttpMethod.GET, "/api/users/me").authenticated()
                        .requestMatchers("/api/users/**").hasAuthority(UserHttpAuthorities.MANAGE_USERS)
